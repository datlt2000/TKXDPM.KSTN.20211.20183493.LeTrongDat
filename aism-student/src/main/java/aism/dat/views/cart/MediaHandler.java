...
public class MediaHandler extends FXMLScreenHandler {
	...
	private void setMediaInfo() {
		...
		URL file = getClass().getResource("/" + cartMedia.getMedia().getImageURL());
