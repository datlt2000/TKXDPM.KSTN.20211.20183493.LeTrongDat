...
import aism.dat.common.exception.ViewCartException;
import aism.dat.controller.HomeController;
import aism.dat.controller.ViewCartController;
import aism.dat.entity.cart.Cart;
import aism.dat.entity.media.Media;
import aism.dat.views.BaseScreenHandler;
...
import aism.dat.views.cart.CartScreenHandler;
...
public class HomeScreenHandler extends BaseScreenHandler implements Initializable{
    ...
    public void setImage(){
        ...
        URL file1 = getClass().getResource(Configs.IMAGE_PATH + "/" + "Logo.png");
        Image img1 = new Image(file1.toString());
        aimsImage.setImage(img1);

        URL file2 = getClass().getResource(Configs.IMAGE_PATH + "/" + "cart.png");
        Image img2 = new Image(file2.toString());
